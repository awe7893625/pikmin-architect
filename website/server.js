...
app.post('/api/license/verify', async (req, res) => {
    ...
    try {
        ...
        return res.json({
            ...
            download: {
                mac: 'https://github.com/awe7893625/pikmin-architect/releases/download/v20260525-icon-and-dmg/KongGoo-1.0.0-arm64.dmg',
...
app.get('/downloads/:file', (req, res) => {
    ...
    if (file === 'ios-location-simulator-mac.dmg') {
        ...
        const rawUrl =
            ...
            'https://github.com/awe7893625/pikmin-architect/releases/download/v20260525-icon-and-dmg/KongGoo-1.0.0-arm64.dmg';
        ...
        const proxyReq = client.get(parsedUrl, (proxyRes) => {
            ...
            if (proxyRes.statusCode !== 200) {
                ...
                const fallbackUrls = [
                    'https://github.com/awe7893625/pikmin-architect/releases/download/v20260525-icon-and-dmg/KongGoo-1.0.0-arm64.dmg?download=1',
